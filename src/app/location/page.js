      ...
      <div className="text-center text-[#FFF6E8] ">
        ...
        <div className="mt-8 bg-[#353535] rounded-lg p-6 space-y-3">
          <h3 className="block uppercase text-[20px] font-[700]">
            Where might they last used tinder?
          </h3>
          <input
            type="number"
            id="age"
            ...
            className="w-full h-12 px-4 bg-[#1C1C1C] text-white text-lg rounded-lg border border-gray-700 focus:outline-none  placeholder-white placeholder:text-[13px]"
          />
