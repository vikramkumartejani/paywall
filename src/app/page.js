    ...
    <div className="bg-[#1C1C1C] overflow-hidden">
      <div className="w-full">
        ...
        <div className="pb-32 md:pb-40 pt-20">
          ...
          <div
            ref={searchRef}
            className={`bg-[#F54E26] w-full px-5 md:py-8 py-4 -mt-8 md:-mt-28 flex items-center flex-wrap justify-center gap-5 transition-all duration-300 ${
              isSticky
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-5">
              <input
                ...
                className="px-5 bg-[#FCFCFC] placeholder:text-black placeholder:text-[14px] md:placeholder:text-[16px] leading-[70px] tracking-[0.64px] gotham-rounded font-medium outline-none h-[40px] sm:h-[51px] md:h-[72px] w-[276px] rounded-lg -mt-2"
              />
